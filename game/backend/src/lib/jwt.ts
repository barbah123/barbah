const DEFAULT_EXPIRY_SECONDS = 30 * 24 * 3600; // 30 gun — mobil oyunda sik giris istenmez
...
export async function verifyJWT(token: string, secret: string): Promise<any> {
  ...
  // Reject anything that isn't the algorithm we issue (prevents alg confusion).
